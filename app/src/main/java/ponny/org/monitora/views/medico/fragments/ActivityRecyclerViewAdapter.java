...
import ponny.org.monitora.views.medico.fragments.ActivityFragment.OnListFragmentInteractionListener;
...
public class ActivityRecyclerViewAdapter extends RecyclerView.Adapter<ActivityRecyclerViewAdapter.ViewHolder> {
    ...
    public ActivityRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
